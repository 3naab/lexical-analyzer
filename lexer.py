...
#     C-Minus code, recognizing keywords, identifiers, numbers, strings,
#     operators, delimiters, and skipping comments.
# -----------------------------------------------------------------------------

import tkinter as tk
from tkinter import ttk, messagebox

# Token types for C-Minus
class TokenType:
...
app = tk.Tk()
app.title("C-Minus Scanner (Lexical Analyzer)")
app.geometry("600x400")

tk.Label(app, text="C-Minus Source Code:").pack(anchor="w", padx=10, pady=5)
input_text = tk.Text(app, height=10, wrap="word")
input_text.pack(fill="both", padx=10, pady=5, expand=True)

tk.Button(app, text="Run Scanner", command=run_scanner).pack(pady=10)
...
tokens_list.heading("Value", text="Token Value")
